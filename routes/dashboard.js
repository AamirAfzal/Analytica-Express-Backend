...
router.post('/indicator/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/intensity/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/gauge/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/pm/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/humidity/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/electricity/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/tvoc/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
...
router.post('/temperature/:device/:sensor', async (req, res) => {
    try {
        //Device Validation
        let deviceId = req.params.device;
